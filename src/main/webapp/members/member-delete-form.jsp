    ...
    <div class="row gx-4 gx-lg-5 justify-content-center">
      <div class="col-md-10 col-lg-8 col-xl-7">
        <div class="page-heading">
          <h1>회원 탈퇴</h1>
          <span style="letter-spacing:2px; word-spacing:10px; margin-top:2vw;" class="subheading">패스워드를 입력하세요.</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row gx-4 gx-lg-5 justify-content-center">
      <div class="col-md-10 col-lg-8 col-xl-7">
        ...
        <div class="my-5">
          ...
          <form id="contactForm" action="member-delete" method="get">
            ...
            <button class="btn btn-primary text-uppercase" id="submitButton" type="submit">회원탈퇴</button>
          </form>
        </div>
      </div>
    </div>
